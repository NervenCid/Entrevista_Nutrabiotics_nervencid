...
#
#   >docker build -t nutrabiotics .
#
#Donde 'nutrabiotics' puede ser cualquier nombre

#Para ejecutar usar el comando
#
#   >docker run -it --publish 7000:4000 nutrabiotics
#
#Donde 'nutrabiotics' es el nombre asignado cuando se compilo la imagen
